...
$columns = array(
    ...
    array('db' => 'par_id', 'dt' => 9, 'field' => 'par_id',
        'formatter' => function ($d, $row) {
            $string = '';
            $string .= '<button id="edit_' . $d . '" class="quotEdit btn btn-xs btn-success" data-toggle="modal" data-target="#modal-edit" data-tooltip="tooltip" data-placement="top" title="Editar datos"><i class="fa fa-pencil"></i></button>';
...
$joinQuery .= " WHERE par_cotiza IS TRUE";
$groupBy = "";
$having = "";
