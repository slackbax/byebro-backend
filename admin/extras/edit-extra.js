$(document).ready(function () {
    ...
    function showResponse(response) {
        ...
        if (response.type === true) {
            new Noty({
                text: '<b>¡Éxito!</b><br>El adicional ha sido editado correctamente. Actualizando datos...',
                type: 'success',
                callbacks: {
                    afterClose: function () {
    ...
    var options = {
        url: 'admin/extras/ajax.editExtra.php',
        type: 'post',
        dataType: 'json',
        ...
        if ($(this).val() !== '') {
            $.ajax({
                ...
                if (r.msg === true) {
                    ...
                    swal({
                        title: "Error!",
                        text: "El nombre de adicional elegido ya se encuentra registrado.",
                        type: "error"
                    });
                } else {
    ...
    $('#btnClear').click(function () {
        $('#gname, #gdetalle').removeClass('has-error has-success');
        $('#iconname, #icondetalle').removeClass('fa-remove fa-check');
    });
