...
<section class="content container-fluid">
	<form role="form" id="formChangePass">
		...
		<div class="box box-default">
			...
			<div class="box-body">
				<div class="row">
					<div class="form-group col-md-6 has-feedback" id="goldpass">
						<label for="ioldpass">Ingresa tu contraseña actual</label>
                        <input type="text" class="form-control" id="iNoldpass" name="ioldpass">
						<input type="hidden" name="uid" id="uid" value="<?php echo $_SESSION['bb_userid'] ?>">
					</div>
				</div>

				<div class="row">
					<div class="form-group col-md-6 has-feedback" id="gnewpass">
						<label for="inewpass">Ingresa tu nueva contraseña</label>
                        <input type="text" class="form-control" id="iNnewpass" name="inewpass">
					</div>
				</div>

				<div class="row">
					<div class="form-group col-md-6 has-feedback" id="gcnpass">
						<label for="icnpass">Confirme su nueva contraseña</label>
                        <input type="text" class="form-control" id="iNcnpass" name="icnpass">
					</div>
				</div>
			</div>
